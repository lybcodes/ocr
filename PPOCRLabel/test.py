...
def rotate_imagine(raw_img_path, save_img_path, angle):
    ...
    for dirpath, dirnames, filenames in os.walk(now_file_path):
        for filename in filenames:
            ...
            save_file_path = save_img_path + 'rrr' + filename
            cv2.imwrite(save_file_path, img)

if __name__=='__main__':
    raw_img_path = 'G:\\lyb\\ocr\\new_img\\img11111\\crop_img\\'
    save_img_path = 'G:\\lyb\\ocr\\new_img\\det_angle90_train\\crop_img\\'
    rotate_imagine(raw_img_path, save_img_path, 90)